...
/**
 * Adaptive date picker dialog that renders as:
 * - iOS: Cupertino-style wheel date picker in a dialog
 * - Android: Material 3 DatePickerDialog with calendar
 *
 * @param visible Whether the dialog is visible
 * @param initialDate The initial date to show in the picker
 * @param yearRange The range of years to allow selection from
